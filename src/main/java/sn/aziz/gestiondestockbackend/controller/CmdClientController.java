...
import sn.aziz.gestiondestockbackend.controller.api.CommandeClientApi;
...
@RestController
public class CmdClientController implements CommandeClientApi {

    private CommandeClientService commandeClientService;

    @Autowired
    public CmdClientController(CommandeClientService commandeClientService) {
