...
import sn.aziz.gestiondestockbackend.repositories.MvtStkRepository;
import sn.aziz.gestiondestockbackend.services.ArticleService;
import sn.aziz.gestiondestockbackend.services.MvtStkService;
import sn.aziz.gestiondestockbackend.validators.MvtStkValidator;
...
public class MvtStkServiceImpl implements MvtStkService {
    ...
    private MvtStkDto entreePositive(MvtStkDto dto, TypeMvtStk typeMvtStk) {
        ...
        if (!errors.isEmpty()) {
            ...
            throw new InvalidEntityException("Le mouvement du stock n'est pas valide", Errorcodes.MVTSTK_NOT_VALID, errors);
        }
        dto.setQuantite(
                BigDecimal.valueOf(
